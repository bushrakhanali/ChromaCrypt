...
const current_users = ['user1', 'user2', 'user3', 'admin', 'user4'];
const new_users = ['user5', 'user6', 'User1', 'user7', 'user8'];
// Using for loop
for (const newUsername of new_users) {
    const exists = current_users.some((existingUsername) => existingUsername.toLowerCase() === newUsername.toLowerCase());
    // By using if else
    if (exists) {
