...
let numberOfPeopleInvited :number = 3;
    
// print a message indicating the number of people you are inviting to dinner.
console.log('There are 3 people invited for dinner\n\n');

//  Make an Array
let dinner_Guests :string[] = ['Bushra Khan', 'B.Khan', 'Bushra K.'];

// Store a message for guest 
const SavoryPalate    :string  = 'AssalamWalaikum Dear ';
const CulinaryExplorer:string   = '\n\nyou are invited for dinner.Looking forward to seeing you.';
const EpicureanVoyager:string   = 'Thanks!!!\n\n';
